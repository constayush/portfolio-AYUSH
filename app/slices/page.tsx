...
const demoItems = [
  ...
  { id: 4, title: "Examples", icon: "-" },
  { id: 8, title: "Resources", icon: "-" },
];
  ...
  return (
    ...
    >
      ...
      <nav className="fixed flex w-full top-0 left-0 border-b border-[var(--border-2-color)] justify-between items-center px-4 py-2 bg-[var(--bg-color)] z-50">
        {/*         
        <span className="w-[5%] h-[120vh] rotate-70 bg-[var(--blob-color)] absolute top-[-10%] right-90 blur-[100px]"></span> */}
        ...
        >
          <div className="px-6 py-8 overflow-y-auto h-full">
            ...
            <ul className="space-y-2">
              {demoItems.map((item) => (
                <li key={item.id}>
                  <button className="w-full text-left px-4 py-3 rounded-lg hover:bg-white/10 transition-colors flex items-center gap-3 group">
