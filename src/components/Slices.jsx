      ...
      <div className="flex flex-col md:flex-row flex-1 gap-4 relative">
        ...
        <nav className="md:hidden  flex justify-center items-center flex-col relative">
          <div className="flex w-full justify-between items-center px-[.65rem]">
            <div className="flex justify-center items-center gap-1">
              <img src={slicesIcon} className="w-[3rem]" />
              <h1 className="text-4xl md:text-3xl font-bold mb-2 text-[var(--text-color)] text-center">
                Slices<span className="text-[var(--accent-color)]">.</span>
              </h1>
            </div>
          ...
          {isExpanded && (
            <motion.div
              ...
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 1, ease: "easeInOut" }}
              className="flex flex-col absolute w-full  mt-[6.5rem] h-[60vh] overflow-y-scroll max-h-[60vh] p-4 rounded-lg gap-2 border-2 border-[var(--border-2-color)] bg-[var(--glass)] backdrop-blur-md md:mt-6 z-[900] top-[0px]"
              id="listOfSlices"
            >
              {GISTS_DATA.map((gist) => (
                <div
        ...
        <main className="flex-1 relative rounded-lg shadow-lg flex flex-col items-center mb-12">
          ...
          <motion.span
            ...
            className="fixed pointer-events-none border border-[#fff] -z-1 top-0 right-0 w-[40%] h-[6rem] bg-[#ffad55] blur-[100px]"
          ></motion.span>
          {selectedGist ? (
            <motion.div
              ...
              className="w-full z-[5]  max-w-7xl  bg-[var(--glass)]
                          rounded-xl p-3 md:p-4 shadow-lg border border-[var(--border-2-color)]  "
            >
