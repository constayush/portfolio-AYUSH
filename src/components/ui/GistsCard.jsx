...
function GistsCard(props) {
  ...
  return (
    ...
    <Link state={props.gist}  to={"/slices/introduction"} className="card relative grow overflow-hidden porject-card min-h-full group  min-w-[100%] transition-all bg-[var(--glass-bg-color)] text-[var(--text-color)] group border-2 shadow-2xl border-[#ffffff10] rounded-lg ">
