  ...
  return (
    <div className="card rounded-lg max-w-[30rem]  ">
      ...
      <div className='group flex flex-col gap-[1.5rem]'>
        <h1 className='projects-h1 group-hover:tracking-[.08rem] transition-all  duration-300 group-hover:text-[#ffffff] text-[#c5c5c5]'>{props.projectName}</h1>
